...
from shapely.geometry import LinearRing, MultiPolygon, Point, Polygon, MultiPoint, MultiLineString, shape
...
def create_rectangle(center, a, b):
    a_half = a * 0.5
    b_half = b * 0.5
    return Polygon([(center[0] - a_half, center[1] - b_half), (center[0] + a_half, center[1] - b_half), (center[0] + a_half, center[1] + b_half), (center[0] - a_half, center[1] + b_half)])
