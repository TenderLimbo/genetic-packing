...
class Solution(object):
    ...
    __slots__ = ("problem", "placed_items", "weight", "value", "packing_density")
            ...
            while not nearest_center_found and radius_of_searching < width + 10:
                for j, pc in self.placed_items.items():
                    if j != i:
                        ...
                        if is_inside_circle(*pc_center, *center, radius_of_searching):
                            nearest_center_found = True
